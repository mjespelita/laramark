                ...
                <table class='table table-striped'>
                    <thead>
                        <tr>
                            ...
                            <th>#</th>
                            <th>Message</th><th>Chats_id</th><th>Chats_users_id</th><th>Users_id</th><th>Has_attachments</th>
                            <th>Actions</th>
                        </tr>
                    </thead>
                    ...
                    <tbody>
                        @forelse($messages as $item)
                            <tr>
                                ...
                                <td>{{ $item->id }}</td>
                                <td>{{ $item->message }}</td><td>{{ $item->chats_id }}</td><td>{{ $item->chats_users_id }}</td><td>{{ $item->users_id }}</td><td>{{ $item->has_attachments }}</td>
                                <td>
